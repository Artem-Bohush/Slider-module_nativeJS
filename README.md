...
```
The example has only four slides, but you can easily scale it by adding blocks with a photo and blocks with a dot (required) to your site layout, as much as necessary. 
